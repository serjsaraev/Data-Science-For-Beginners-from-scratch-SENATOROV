...
# # 12/12
#
# Поговорили про PATH - переменные, построили PMF график, использовали формулу Ньютона-Лейбница. Договорились, что с субботы начинаем доп математику.

# # 14/12
# # Дисперсия ДСВ + среднее квадратическое отклонение.
...
# ДЗ экзаменационный контроль, книга proba, Задачник ДСВ, матанализ
