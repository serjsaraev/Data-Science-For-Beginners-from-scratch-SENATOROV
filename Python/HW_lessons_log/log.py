...
# 09/01/2025 Разбирались? что задано для самостоятельной работы. Определили часть выполненных ишьюсов (мизерная, мне стыдно). Пришли к выводу о необходимости перехода на программу Data science. Создали файл random_variable.ipynb. Со следующей недели приступаем к линейной алгебре.
