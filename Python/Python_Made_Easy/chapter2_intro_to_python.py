...
# тестировать функции во время нисходящей разработки программы. Python
# позволяет писать программы компактно и читабельно
...
# Это сочетание Java и Python преобразует код Python в байт-код Java.
#
# 5. PyPy
#
...
# CPython, Stackless Python написан с использованием С и Python. Важная
# особенность - это наличие микропотоков. Эта возможность помогает избежать
# значительной части накладных: расходов, связанных с обычными потоками
...
#
# ♦ Частичное избавление от головной боли на предмет того, какая версия пакета
# Х совместима с какой версией пакета У, когда оба они требуются для установки
# пакета Z.
#
...
# ♦ Jupyter Notebook
#
# Сконструирован как веб-приложение, подходящее для записи всего
# вычислительного процесса: разработки, документирования и выполнения кода, а
# также передачи результатов. Объединяет в себе два компонента:
...
# слайд-шоу, с помощью команды nbconvert. Любой документ Notebook формата
# ipynb, доступный по публичному URL-адресу, можно опубликовать через Jupyter
# Notebook Viewer (nbviewer) как статическую веб-страницу.
#
...
# многострочное текстовое поле ввода, содержимое которого можно выполнить либо
# с помощью комбинации клавиш Shift + Enter, либо путем нажатия кнопки Play на
...
# преобразуется в интерактивную ссылку на этот раздел документа. Markdown
# также допускает форматирование с помощью HTML-кода.
#
...
# программы. Бесплатное ПО - сама программа бесплатная (скорее всего без
# доступа к коду)
#
...
#
# Можно использовать на разных типах машин, независимо от аппаратных средств
