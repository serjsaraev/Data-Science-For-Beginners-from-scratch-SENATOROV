...
list_vec = [1, 2, 3]  #
arr_vec = np.array(list_vec)
# это одномерный массив скобочки одинарные = неориентированный вектор
arr_vec.ndim  # показывает количество измерений
arr_vec.shape
# показывает количество строк и столбцов (3,) 1- param row, 2 - column
